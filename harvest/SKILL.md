---
name: harvest
description: "Captura aprendizados da sessao atual e salva em D:\\Mega\\CLAUDE CODE DJ CONTROL\\dlsdigital-operacao-ia\\logs\\harvest\\ (Mega + git) e na VPS. Use /harvest ao final de qualquer sessao produtiva."
model: sonnet
effort: low
---
...
Analise a sessao atual e salve os aprendizados em DOIS lugares:
...
- Salvar SEMPRE nos dois lugares (Mega + VPS)
...
- Confirmar os 3 destinos salvos ao final: Mega, VPS, Git
